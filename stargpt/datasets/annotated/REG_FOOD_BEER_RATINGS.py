...
Beer Name (Full) (object, 3197 distinct): ['Alaskan Brewing Co. Alaskan Amber', 'Long Trail Brewing Co. Double Bag', 'Long Trail Brewing Co. Long Trail Ale', 'Uerige Obergärige Hausbrauerei GmbH / Zum Uerige Uerige Doppelsticke', "Ninkasi Brewing Company Sleigh'r Dark Doüble Alt Ale", 'Uerige Obergärige Hausbrauerei GmbH / Zum Uerige Uerige Sticke', 'Widmer Brothers Brewing Company Okto', 'Southampton Publick House Southampton Altbier', 'The Olde Mecklenburg Brewery OMB Copper', 'Brauerei Pinkus Mueller Organic Münster Alt']
Description (object, 1841 distinct): ['Notes:', 'Notes:21 IBU\\t', 'Notes:Busch and Busch Light are both brewed with a blend of premium American-grown and imported hops and a combination of malt and corn to provide a pleasant balanced flavor. Additionally, Busch Light undergoes a longer brewing process that produces a lighter body and fewer calories.\\t', 'Notes:A Silver Medal winner in Strong Ales at the 1996 Great American Beer Festival. This Irish-style strong ale is brewed with a secret blend of five imported specialty malts. Not too hoppy in order to emphasize the complex malt flavor and fruity aroma.25 IBU\\t', 'Notes:Down in Kentucky and across the pond in Scotland, distillers who age their whiskeys for many years refer to the evaporation of the spirits from their barrels as “The Angel’s Share.” We couldn’t agree more. Each time a barrel is filled, a measure of liquid seeps into the oak and is lost for good.This striking Strong Ale is brewed with copious amounts of Caramel malt to emphasize the vanilla and oak flavors found in freshly emptied bourbon or brandy barrels. The beer spends a year in oak before it is packaged for release.\\t', 'Notes:22 IBU\\t', 'Notes:20 IBU\\t', 'Notes:Munich and various roasted malts give it a very malty, rich flavor with a hint of burnt flavor. 100% imported Hallertau hops, moderate bitterness and aroma.\\t', "Notes:O'Doul's and O'Doul's Amber are non-alcohol malt beverages.O’Doul’s has a mild, sweet taste with a slightly dry finish. O’Doul’s Amber has a rich, slightly sweet taste with flavorful hop finish. O’Doul’s and O’Doul’s Amber are brewed as traditional premium beers – fermented and aged to full maturity. The alcohol is then removed through the use of low temperature, low-pressure distillation. This extremely gentle process allows the alcohol to be removed without heating or cooking the beer, which retains the full, rich and delicate flavor and balance of our non-alcohol brews.\\t", 'Notes:The essence of Christmas is captured in this very bottle. Perfectly blended spices compliment Frosted Frog’s rich malt flavors, creating the ultimate Christmas experience. Celebrate the holidays as you savor this very special seasonal offering.\\t']
...
def load_df(dir_path: str) -> DataFrame:
    df_path = join(dir_path, "beer_profile_and_ratings.csv")
    df = read_csv(df_path)
    return df
